    ...
    def __init__(
        ...
        self.block = nn.Sequential(
            nn.Conv2d(
                ...
                groups=in_channels,  # 设置 groups 参数为输入通道数，实现深度可分离卷积 ，逐通道卷积
            ),
            nn.Conv2d(
                in_channels=in_channels,
...
class CellViTSAM(nn.Module):
    ...
    def load_pretrained(self, model_path):
        ...
        state_dict = torch.load(str(model_path), map_location=torch.device('cpu'))['model_state_dict']
    
        msg =self.load_state_dict(state_dict, strict=False)
        
        print(f"Loading precheckpoint: {msg}")

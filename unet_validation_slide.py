...
def main(datadir, model_dir1,model_dir2,model_dir3,model_dir4,output_dir):
    ...
    with torch.no_grad():
        ...
        for val_data in val_loader:
            ...
            print("\n")
            print("slide level F1 metric:", (f1_scores_50[0]))
            print("slide level AP(50) metric:", (ap50[0]))
            print("slide level Dice metric:", (dice_coefficient(wsi_prediction_sm, wsi_mask)))
...
if __name__ == "__main__":
    ...
    # output_dir = '/ssd/cyj/code/window/'
    ...
    parser.add_argument(
        "--data_path",
        default="/ssd/cyj/KPIs24datanew/task2/val/",
        type=str,
    ...
    parser.add_argument(
        "--model_dir1",
        default="/ssd/cyj/KPIs24datanew/model/model1.pth",
        type=str,
        help="model_dir1",
    )    
    parser.add_argument(
        "--model_dir2",
        default="/ssd/cyj/KPIs24datanew/model/model2.pth",
        type=str,
        help="model_dir2",
    )    
    ...
    parser.add_argument(
        "--model_dir3",
        default="/ssd/cyj/KPIs24datanew/model/model3.pth",
        type=str,
        help="model_dir13",
    )   
    parser.add_argument(
        "--model_dir4",
        default="/ssd/cyj/KPIs24datanew/model/model4.pth",
        type=str,
        help="model_dir4",
    )
    ...
    model_dir1=args.model_dir1
    model_dir2=args.model_dir2
    model_dir3=args.model_dir3
    model_dir4=args.model_dir4
